...
def generarMenu(usuario):
    ...
    with st.sidebar:
        ...
        st.page_link("LimpiezaDatasets/pages/pagina1.py", label="KELQ", icon=":material/sell:")
        st.page_link("LimpiezaDatasets/pages/pagina2.py", label="AES", icon=":material/shopping_cart:")
        st.page_link("LimpiezaDatasets/pages/pagina3.py", label="FTV", icon=":material/group:")    
